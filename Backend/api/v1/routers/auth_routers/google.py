...
from api.v1.services.auth_services.google import GoogleAuthService, JWT_TOKEN_EXPIRE_MINUTES
import secrets
...
async def login_google():
    ...
    auth_url = GoogleAuthService.get_google_auth_url(state)
...
async def auth_google_callback(
    ...
    try:
        result = await GoogleAuthService.handle_google_callback(code, state, request)
